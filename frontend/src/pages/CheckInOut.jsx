        ...
        <table className="min-w-full bg-white shadow rounded-lg overflow-hidden">
          ...
          <tbody className="text-gray-700 text-sm">
            {visitors.map((v, index) => (
              <tr key={v._id} className={index % 2 === 0 ? "bg-gray-50" : "bg-white"}>
                ...
                <td className="px-6 py-4 text-center">
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      updated[index].check_in = e.target.value
                      setVisitors(updated)
                    }}
                  ...
                  <button
                    ...
                    className="px-2 ml-2 py-1 rounded text-white bg-indigo-600 hover:bg-indigo-700"
                  >
                    ➤
                  </button>
                </td>
                ...
                <td className="px-6 py-4 text-center">
                  <input
                    ...
                    onChange={(e) => {
                      const updated = [...visitors]
                      updated[index].check_out = e.target.value
                      setVisitors(updated)
                    }}
                    className="border px-2 py-1 rounded w-24 text-center"
                  />
